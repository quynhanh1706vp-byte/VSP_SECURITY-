#!/usr/bin/env bash
# VSP — Final UI: Multi-tenant + Executive Summary
set -e
echo ">>> Multi-tenant UI + Executive Summary PDF"
mkdir -p static

cat > 'static/index.html' << 'VSP_FINAL_UI'
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div id="appScreen" style="display:none">
  <nav class="nav">
    ...
    <div class="nav-tabs">
      ...
      <button class="tab" onclick="showPanel('executive',this)">Executive</button>
    </div>
    <!-- Tenant switcher -->
    <div style="display:flex;align-items:center;gap:0;margin-right:16px;border:1px solid var(--border2)">
      <span style="font-size:9px;letter-spacing:.15em;color:var(--text3);padding:0 10px;text-transform:uppercase;border-right:1px solid var(--border2);white-space:nowrap">Tenant</span>
      <select id="tenantSwitcher" onchange="switchTenant(this.value)"
        style="background:none;border:none;color:var(--amber);font-family:var(--mono);font-size:11px;padding:0 10px;cursor:pointer;outline:none;height:32px">
...
echo "================================================================"
echo "  Final UI: http://localhost:8922"
echo "  New tabs: Tenant switcher | Executive Summary"
echo "================================================================"
